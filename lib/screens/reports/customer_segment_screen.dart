                ...
                child: GridView.count(
                  ...
                  children: [
                    _buildKpiCard(
                      ...
                      value: (_kpis!['activeCustomers'] ?? 0).toString(),
                    ...
                    _buildKpiCard(
                      title: 'AVG. LTV',
                      value: 'IDR ${_fmtShort((_kpis!['avgLtv'] as num?)?.toDouble() ?? 0.0)}',
                    ...
                    _buildKpiCard(
                      title: 'TOP SPENDER',
                      value: (_kpis!['topSpenderName'] ?? '-').toString(),
                      subtitle: 'Spend: IDR ${_fmtShort((_kpis!['topSpenderLtv'] as num?)?.toDouble() ?? 0.0)}',
                    ...
                    _buildKpiCard(
                      ...
                      value: '${((_kpis!['newCustomerRatio'] as num?)?.toDouble() ?? 0.0).toStringAsFixed(1)}%',
